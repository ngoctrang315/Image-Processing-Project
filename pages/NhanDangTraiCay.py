...
add_bg_from_local('D:/Year3/HK2/XLA/do_an_cuoi_ki/Image-Processing-Project/Background/NhanDangTraiCay.jpg')  
st.markdown("""
<style>
...
try:
    ...
    st.session_state["Net"] = cv2.dnn.readNet("D:/Year3/HK2/XLA/do_an_cuoi_ki/Image-Processing-Project/ModelNhanDangTraiCay/trai_cay.onnx")
...
if img_file_buffer is not None:
    ...
    if st.button('Predict'):
        classes = ['ambulance', 'bicycle', 'bus', 'fire_truck', 'motorbike']
        # Process image.
